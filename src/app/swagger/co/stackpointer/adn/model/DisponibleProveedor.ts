...
export interface DisponibleProveedor {
    

    /**
     * Identificador del Disponible para Proveedores
     */
    id?: string;

    /**
     * Nombre del Disponible para Proveedores
     */
    nombre?: string;

    /**
     * observaciones del Disponible para Proveedores
     */
